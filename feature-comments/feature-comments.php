...
FeatureComments::init();
abstract class FeatureComments
{
        static $actions = array('bury' => 'Demote', 'unbury' => 'Clear Demotion');
        /** Filters & Actions **/
        static function init()
        {
                /* Backend */
                //add_action('edit_comment', array('FeatureComments', 'save_meta_box_postdata'));
                //                add_action('admin_menu', array('FeatureComments', 'add_meta_box'));
                add_action('wp_ajax_feature_comments', array('FeatureComments', 'ajax'));
                add_filter('edit_comment_link', array('FeatureComments', 'comment_text'), 10, 3);
                //                add_filter('comment_row_actions', array('FeatureComments', 'comment_row_actions'));

                add_action('wp_print_scripts', array('FeatureComments', 'wp_print_scripts'));
                add_action('admin_print_scripts', array('FeatureComments', 'wp_print_scripts'));
                add_action('wp_print_styles', array('FeatureComments', 'wp_print_styles'));
                //add_action('admin_print_styles', array('FeatureComments', 'wp_print_styles'));

                /* Frontend */
                add_filter('comment_class', array('FeatureComments', 'comment_class'));
        ...
        {
                add_meta_box('comment_meta_box', __( 'Feature Comments'), array('FeatureComments', 'comment_meta_box'), 'comment', 'normal');
        }
